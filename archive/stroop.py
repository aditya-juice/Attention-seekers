...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/q/Documents/GitHub/NeuroTech/Attention-seekers/stroop.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Welcome to the Attention Seekers Stroop Task!\nPress RIGHT arrow key for inconsistent prompts, e.g. yellow pops up with color green.\nPress LEFT arrow key for consistent prompts, e.g. red pops up with color red.\nTry to get as many correct as possible in <insert total time>!\n\nPress SPACE key to continue.',
        font='Arial',
    ...
    stroop = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('trial_file_146820_20250124_041047_UTC.xlsx'), 
        seed=None, 
    )
    ...
    for thisStroop in stroop:
        ...
        time_fix = np.random.uniform(2,5)
        ...
        while continueRoutine:
            ...
            if fix_rand.status == STARTED:
                ...
                if tThisFlipGlobal > fix_rand.tStartRefresh + time_fix-frameTolerance:
                    # keep track of stop time/frame for later
    ...
    # completed 36.0 repeats of 'stroop'
